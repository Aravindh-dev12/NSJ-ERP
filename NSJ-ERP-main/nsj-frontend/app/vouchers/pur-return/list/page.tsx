...
import { purReturnList, purReturnDelete, type QueryValue } from "@/lib/backend";
...
export default function PurReturnListPage() {
  ...
  const fetchList = useCallback(async () => {
    ...
    try {
      ...
      const response = await purReturnList({
        ...params,
        date_from: dateFrom,
        date_to: dateTo,
      });
      ...
      setError("Failed to load pur. returns. Please try again.");
      toast({
        variant: "destructive",
        title: "Unable to load Pur. Returns",
        description:
  ...
  const handleDelete = useCallback(
    async (id: string) => {
      ...
      setDeletingId(id);
      try {
        await purReturnDelete(id);
        toast({
          title: "Pur. Return removed",
  ...
  return (
    <div className="space-y-8">
      ...
      <SalesHeader
        title="Pur. Returns"
        description="Manage purchase returns: create, review and keep records."
        links={[
      ...
      <Card>
        <CardHeader className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <CardTitle className="text-xl">Pur. Return list</CardTitle>
              <CardDescription>
                Search, filter, and maintain purchase returns in one place.
              </CardDescription>
            </div>
            <div className="ml-auto">
              <Link href="/vouchers/pur-return/add-new">
                <Button>Create Pur. Return</Button>
              </Link>
            </div>
          </div>
