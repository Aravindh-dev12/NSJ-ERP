...
import { paymentOverview, type QueryValue } from "@/lib/backend";
...
export default function PaymentsOverviewPage() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        const resp = await paymentOverview();
  ...
  return (
    <div className="space-y-8">
      ...
      <SalesHeader
        ...
        description="Monitor payment entries and create new payments."
        links={[
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2 border-rose-100 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              The last 5 payment vouchers created.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
