...
export default function LabsPage() {
  ...
  const submitEdit = async () => {
    ...
    setIsSubmitting(true);
    try {
      await labUpdate(selectedItem.id, {
        name: formData.name.trim(),
      });
      toast({
  ...
  const submitDelete = async () => {
    ...
    setIsSubmitting(true);
    try {
      await labDelete(selectedItem.id);
      toast({
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Available labs</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle>All Labs ({filteredItems.length})</CardTitle>
          <CardDescription>
            {searchQuery
              ? `Showing ${filteredItems.length} of ${items.length} labs`
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Create a new lab</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Update the lab</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4 px-6">
            <div className="space-y-2">
