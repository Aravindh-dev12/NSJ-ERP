...
const DEFAULT_LINKS = [
  { label: "Overview", href: "/process/ghat-quality-check" },
  { label: "List", href: "/process/ghat-quality-check/list" },
  { label: "Add New", href: "/process/ghat-quality-check/add" },
];

type NavLink = { label: string; href: string };

type GhatQualityCheckHeaderProps = {
  title: string;
  description?: string;
  links?: NavLink[];
};

export function GhatQualityCheckHeader({
  title,
  description,
  links,
}: GhatQualityCheckHeaderProps) {
