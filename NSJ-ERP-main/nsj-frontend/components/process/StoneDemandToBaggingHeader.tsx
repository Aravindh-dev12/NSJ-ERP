...
const DEFAULT_LINKS = [
  { label: "Overview", href: "/process/stone-demand-to-bagging" },
  { label: "List", href: "/process/stone-demand-to-bagging/list" },
  { label: "Add New", href: "/process/stone-demand-to-bagging/add" },
];

type NavLink = { label: string; href: string };

type StoneDemandToBaggingHeaderProps = {
  title: string;
  description?: string;
  links?: NavLink[];
};

export function StoneDemandToBaggingHeader({
  title,
  description,
  links,
}: StoneDemandToBaggingHeaderProps) {
