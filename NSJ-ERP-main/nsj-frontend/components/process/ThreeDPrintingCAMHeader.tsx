...
const DEFAULT_LINKS = [
  { label: "Overview", href: "/process/3d-printing-cam" },
  { label: "List", href: "/process/3d-printing-cam/list" },
  { label: "Add New", href: "/process/3d-printing-cam/add" },
];

type NavLink = { label: string; href: string };

type ThreeDPrintingCAMHeaderProps = {
  title: string;
  description?: string;
  links?: NavLink[];
};

export function ThreeDPrintingCAMHeader({
  title,
  description,
  links,
}: ThreeDPrintingCAMHeaderProps) {
