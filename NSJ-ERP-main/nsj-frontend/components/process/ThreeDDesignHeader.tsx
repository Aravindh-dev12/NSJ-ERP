...
const DEFAULT_LINKS = [
  { label: "Overview", href: "/process/3d-design" },
  { label: "List", href: "/process/3d-design/list" },
  { label: "Add New", href: "/process/3d-design/add" },
];

type NavLink = { label: string; href: string };

type ThreeDDesignHeaderProps = {
  title: string;
  description?: string;
  links?: NavLink[];
};

export function ThreeDDesignHeader({
  title,
  description,
  links,
}: ThreeDDesignHeaderProps) {
