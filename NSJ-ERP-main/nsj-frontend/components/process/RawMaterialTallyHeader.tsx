...
const DEFAULT_LINKS = [
  { label: "Overview", href: "/process/raw-material-tally" },
  { label: "List", href: "/process/raw-material-tally/list" },
  { label: "Add New", href: "/process/raw-material-tally/add" },
];

type NavLink = { label: string; href: string };

type RawMaterialTallyHeaderProps = {
  title: string;
  description?: string;
  links?: NavLink[];
};

export function RawMaterialTallyHeader({
  title,
  description,
  links,
}: RawMaterialTallyHeaderProps) {
