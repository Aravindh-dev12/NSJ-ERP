...
const DEFAULT_LINKS = [
  { label: "Overview", href: "/process/item-final-packing-list" },
  { label: "List", href: "/process/item-final-packing-list/list" },
  { label: "Add New", href: "/process/item-final-packing-list/add" },
];

type NavLink = { label: string; href: string };

type ItemFinalPackingListHeaderProps = {
  title: string;
  description?: string;
  links?: NavLink[];
};

export function ItemFinalPackingListHeader({
  title,
  description,
  links,
}: ItemFinalPackingListHeaderProps) {
