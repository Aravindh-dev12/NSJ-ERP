...
export default function PurchaseMList() {
  ...
  const fetchList = useCallback(async () => {
    ...
    try {
      ...
      const response = await purchaseMList(params);
      ...
      <Card>
        <CardHeader className="space-y-4">
          <div className="flex items-center justify-between gap-3">
            <div>
              <CardTitle className="text-xl">Purchase M</CardTitle>
            </div>
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    a.href = url;
                    a.download = fileName ?? "purchase_data.xlsx";
