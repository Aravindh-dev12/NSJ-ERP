...
const DEFAULT_LINKS = [
  { label: "Overview", href: "/vouchers/sales-leads" },
  { label: "List", href: "/vouchers/sales-leads/list" },
  { label: "Add New", href: "/vouchers/sales-leads/new" },
];

type NavLink = { label: string; href: string };

type SalesLeadsHeaderProps = {
  title: string;
  description?: string;
  links?: NavLink[];
};
